...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('Lᴜᴄɪғᴇʀ Bᴏᴛ Lᴏɢs', url="t.me/assimilat0r")
                     ], [
                      InlineKeyboardButton('Gʀᴏᴜᴘ', url='t.me/+92Pvd1qg_ZtmNjU1'),
                      InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url='t.me/assimilat0r')
                     ], [
                      InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='t.me/assimilat0r'),
                      InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='t.me/assimilat0r')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
        ...
        for file in files:
            ...
            if result.deleted_count:
                logger.info('EXE File Found ! Successfully deleted from database.')
            deleted+=1
        deleted = str(deleted)
        await k.edit_text(text=f"<b>Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ {deleted} Exe Fɪʟᴇs.</b>") 
        ...
        for file in files:
            ...
            deleted+=1
        deleted = str(deleted)
        await k.edit_text(text=f"<b>Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ {deleted} srt Fɪʟᴇs.</b>")
